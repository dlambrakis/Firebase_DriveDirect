...
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case "DISMISS_TOAST": {
      ...
      // Side effect: schedules a toast for removal after a delay.
      if (toastId) {
...
/**
 * Imperatively creates and displays a new toast notification.
...
/**
 * A React hook that provides access to the current list of toasts
