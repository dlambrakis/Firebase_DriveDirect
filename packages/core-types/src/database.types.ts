  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          public_id: string
          residential_type:
            | Database["public"]["Enums"]["residential_type_enum"]
            | null
    ...
    Functions: {
      ...
      create_counter_offer: {
        Args: { original_offer_id: string; new_amount: number }
        Returns: {
          amount: number
          conversation_id: number | null
          created_at: string
      ...
      get_aspirations_for_model_and_year: {
        Args: { p_model_id: number; p_year: number }
        Returns: {
          id: number
          name: string
        }[]
      ...
      get_user_listings: {
        Args: { p_user_id: string } | { p_user_id: string; p_limit?: number }
        Returns: {
          created_at: string | null
          description: string | null
          features: Json | null
      ...
      get_variants_by_make_and_model_ids: {
        Args: { p_make_ids: number[]; p_model_ids: number[] }
        Returns: {
          variant_id: number
          variant: string
          is_active: boolean
      ...
      get_vehicle_variant_options: {
        Args: { p_model_id: string; p_year: number }
        Returns: Json
      }
      ...
      update_vehicle_features: {
        Args: { p_vehicle_id: string; p_feature_ids: string[] }
        Returns: undefined
      }
